        ...
        ColumnLayout {
          ...
          Repeater {
            ...
            delegate: RowLayout {
              ...
              NText {
                text: {
                  const usedGb = SystemStatService.diskUsedGb[modelData] || 0;
                  const sizeGb = SystemStatService.diskSizeGb[modelData] || 0;
                  const percent = SystemStatService.diskPercents[modelData] || 0;
